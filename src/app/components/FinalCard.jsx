                            ...
                            {!isRevealed ? (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <h3 className="text-3xl md:text-4xl font-bold text-pink-600 mb-2">मेरे सारे प्यार के साथ ,</h3>

                                        <h3 className="text-4xl md:text-5xl font-bold text-purple-600">Mayank Yadav</h3>
                                    </motion.div>
